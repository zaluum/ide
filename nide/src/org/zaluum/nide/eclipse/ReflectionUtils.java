...
public class ReflectionUtils {
	...
	// //////////////////////////////////////////////////////////////////////////
	/**
	 * @return the {@link ClassLoader} that was used to load given {@link Class}
	 *         . Always return not <code>null</code> value, even if
	 *         {@link Class} was loaded using bootstrap {@link ClassLoader}.
	 */
	...
	/**
	 * @return the {@link Object} default value for class - false/zero for
	 *         primitives, <code>"dynamic"</code> for {@link String} and empty
	 *         collections.
	 */
	 ...
	 * @param requiredClass
	 *            the name of {@link Class} that should be extended, or name of
	 *            interface that should be implemented.
	 * 
	 * @return <code>true</code> if given {@link Class} extends
	 *         <code>requiredClass</code> or implements interface with this
	 *         name.
	 */
	public static boolean isSuccessorOf(Class<?> clazz, String requiredClass) {
		...
		// check cache
		{
			IsSuccessorResult result = isSuccessorOf_checkCache(clazz,
					requiredClass);
		...
		for (Class<?> interfaceClass : clazz.getInterfaces()) {
			if (isSuccessorOf(interfaceClass, requiredClass)) {
				isSuccessorOf_addCache(clazz, requiredClass,
						IsSuccessorResult.TRUE);
				return true;
			}
		}
	...
	private static void isSuccessorOf_addCache(Class<?> clazz,
		...
		WeakHashMap<Class<?>, IsSuccessorResult> classes = m_isSuccessorOfCache
				.get(requiredClass);
		if (classes == null) {
	...
	private static IsSuccessorResult isSuccessorOf_checkCache(Class<?> clazz,
	 ...
	 */
	/*
	 * public static boolean isMemberClass(final Class<?> clazz) { return
	 * ExecutionUtils.runObjectIgnore(new RunnableObjectEx<Boolean>() { public
	 * Boolean runObject() throws Exception { return clazz.isMemberClass(); } },
	 * false); }
	 */
	// //////////////////////////////////////////////////////////////////////////
	//
	...
	// //////////////////////////////////////////////////////////////////////////
	/**
	 * @return <code>true</code> if two arrays have same number of classes and
	 *         all "specific" classes are {@link #isMoreSpecific(Class, Class)}
	 *         than "base".
	 */
	...
	// //////////////////////////////////////////////////////////////////////////
	/**
	 * @return <code>true</code> if given {@link Class} that is "enchanced",
	 *         i.e. is generated by "CGLib", or some other library.
	 */
	...
	/**
	 * @return the super-Class of given {@link Class} that is "normal", i.e. is
	 *         not generated by "CGLib", or some other library. For now we just
	 *         check that {@link Class} name has no <code>'$'</code> character.
	 */
	...
	/**
	 * @return the {@link String} presentation of given {@link Method}. If this
	 *         {@link Method} is declared in some "enchanced" {@link Class}, and
	 *         there was same {@link Method} in "normal" {@link Class}, then
	 *         <code>toString</code> of "normal" {@link Method} returned.
	 */
	public static String toString(Method method) {
		...
		while (isEnchancedClass(method.getDeclaringClass())) {
			...
			Method superMethod = getMethodBySignature(superClass,
					methodSignature);
			if (superMethod == null) {
				break;
			}
	...
	/**
	 * @param runtime
	 *            is <code>true</code> if we need name for class loading,
	 *            <code>false</code> if we need name for source generation.
	 * 
	...
	public static String getFullyQualifiedName(Type type, boolean runtime) {
		...
		if (type instanceof WildcardType) {
			...
			return "? extends "
					+ getFullyQualifiedName(wildcardType.getUpperBounds()[0],
							runtime);
		}
		// TypeVariable
	 ...
	 * <code>"()"</code>).
	 */
	private static void appendParameterTypes(StringBuilder buffer,
			Type[] parameterTypes) {
		buffer.append('(');
	 ...
	 * <p>
	 * GWT has problems with canonical name of inner class, so we need such
	 * workaround.
	...
	/**
	 * Returns the short name of {@link Class}, or same name for simple type
	 * name.
	 * 
	 * <pre>
	...
	/**
	 * @return signature for given {@link Method}. This signature is not same
	 *         signature as in JVM or JDT, just some string that unique
	 *         identifies method in its {@link Class}.
	 */
	...
	/**
	 * Returns the signature of {@link Method} with given combination of name
	 * and parameter types. This signature is not same signature as in JVM or
	...
	/**
	 * @return generic signature for given {@link Method}. This signature is not
	 *         same signature as in JVM or JDT, just some string that unique
	 *         identifies constructor in its {@link Class}. It uses
	 *         {@link Method#getGenericParameterTypes()}, so for each
	...
	/**
	 * Note: you should not use this method, using
	 * {@link #getMethodBySignature(Class, String)}.
	 * 
	 * @return the {@link Method} for given name, or <code>null</code> if no
	 *         such method found.
	 */
	...
	private static final ClassMap<Map<String, Method>> m_getMethodBySignature = ClassMap
			.create();

	/**
	 * Returns the {@link Method} defined in {@link Class}. This method can have
	 * any visibility, i.e. we can find even protected/private methods. Can
	 * return <code>null</code> if no method with given signature found.
	 * 
	 * @param clazz
	 *            the {@link Class} to get method from it, or its superclass.
	 * @param signature
	 *            the signature of method in same format as
	 *            {@link #getMethodSignature(Method)}.
	 * 
	 * @return the {@link Method} for given signature, or <code>null</code> if
	 ...
	 * 
	 * @return the {@link Method} for given signature. This constructor can have
	 *         any visibility, i.e. we can find even protected/private
	 *         constructors.
	 */
	public static Method getMethodByGenericSignature(Class<?> clazz,
			String signature) {
	 ...
	 * Returns the {@link Method} defined in {@link Class}. This method can have
	 * any visibility, i.e. we can find even protected/private methods. Can
	 * return <code>null</code> if no method with given combination of
	 * name/parameters found.
	 * 
	 * @param clazz
	 *            the {@link Class} to get method from it, or its superclass.
	 * @param name
	 ...
	 * 
	 * @return the {@link Method} for given name/parameters, or
	 *         <code>null</code> if no such method found.
	 */
	...
	/**
	 * @return <code>true</code> if given {@link Method} is declared in
	 *         {@link Class} with given name or one of its superclasses.
	 */
	public static boolean isAlreadyDeclaredIn(Method method,
			Class<?> targetClass) {
	...
	/**
	 * @return <code>true</code> if two {@link Method}s have same name, but
	 *         parameter types of "specific" are
	 *         {@link #isMoreSpecific(Class[], Class[])} than "base".
	 */
	public static boolean isMoreSpecific(Method base, Method specific) {
		return base.getName().equals(specific.getName())
				&& isMoreSpecific(base.getParameterTypes(),
						specific.getParameterTypes());
	}

	/**
	 * @return the {@link Method} which is
	 *         {@link #isMoreSpecific(Method, Method)} than all others.
	 */
	...
	/**
	 * @return the {@link Object} result of invoking method with given
	 *         signature.
	 */
	public static Object invokeMethodEx(Object object, String signature,
			Object... arguments) {
		try {
	 ...
	 *         signature.
	 */
	public static Object invokeMethod(Object object, String signature,
	 ...
	 */
	public static Object invokeMethod2(Object object, String name)
			throws Exception {
	 ...
	 */
	public static Object invokeMethod2(Object object, String name,
			Class<?> parameterType_1, Object argument_1) throws Exception {
	 ...
	 */
	public static Object invokeMethod2(Object object, String name,
			Class<?> parameterType_1, Class<?> parameterType_2,
			Object argument_1, Object argument_2) throws Exception {
	...
	public static Object invokeMethod2(Object object, String name,
			Class<?> parameterType_1, Class<?> parameterType_2,
			Class<?> parameterType_3, Object argument_1, Object argument_2,
	...
	public static Object invokeMethod2(Object object, String name,
			Class<?> parameterType_1, Class<?> parameterType_2,
			Class<?> parameterType_3, Class<?> parameterType_4,
			Object argument_1, Object argument_2, Object argument_3,
			Object argument_4) throws Exception {
		Class<?>[] types = new Class<?>[] { parameterType_1, parameterType_2,
				parameterType_3, parameterType_4 };
		Object[] values = new Object[] { argument_1, argument_2, argument_3,
				argument_4 };
		return invokeMethod2(object, name, types, values);
	}
	 ...
	 * 
	 * @param object
	 *            the object to call, may be {@link Class} for invoking static
	 *            method.
	 * @param name
	 *            the name of method.
	 * @param parameterTypes
	...
	// //////////////////////////////////////////////////////////////////////////
	/**
	 * @return signature for given {@link Constructor}. This signature is not
	 *         same signature as in JVM or JDT, just some string that unique
	 *         identifies constructor in its {@link Class}.
	 */
	...
	/**
	 * @return generic signature for given {@link Constructor}. This signature
	 *         is not same signature as in JVM or JDT, just some string that
	 *         unique identifies constructor in its {@link Class}. It uses
	 *         {@link Constructor#getGenericParameterTypes()}, so for each
	 *         {@link TypeVariable} its name will be used in signature.
	 */
	public static String getConstructorGenericSignature(
			Constructor<?> constructor) {
		return getConstructorSignature(constructor.getGenericParameterTypes());
	}

	/**
	 * Returns the signature of {@link Constructor} with given parameter types.
	 * This signature is not same signature as in JVM or JDT, just some string
	 * that unique identifies constructor in its {@link Class}.
	 * 
	 * @param parameterTypes
	 ...
	 * 
	 * @return the {@link Constructor} for given signature. This constructor can
	 *         have any visibility, i.e. we can find even protected/private
	 *         constructors.
	 */
	@SuppressWarnings("unchecked")
	public static <T> Constructor<T> getConstructorBySignature(Class<T> clazz,
			String signature) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> Constructor<T> getConstructorByGenericSignature(
			Class<T> clazz, String signature) {
		// check all declared constructors
		for (Constructor<?> constructor : clazz.getDeclaredConstructors()) {
	...
	/**
	 * @return the {@link Constructor} which can be invoked with given
	 *         arguments, may be <code>null</code>.
	 */
	@SuppressWarnings("unchecked")
	public static <T> Constructor<T> getConstructorForArguments(Class<T> clazz,
			Object... arguments) {
	...
	/**
	 * @return the {@link Field} of given class with given name or
	 *         <code>null</code> if no such {@link Field} found.
	 */
	...
	// //////////////////////////////////////////////////////////////////////////
	/**
	 * @return the {@link Class} of given {@link Object} or casted object, if it
	 *         is {@link Class} itself.
	 */
	...
	/**
	 * @return the {@link Object} that should be used as argument for
	 *         {@link Field#get(Object)} and
	 ...
	 */
	/*
	 * private static class ExceptionThrower { private static Throwable
	 * throwable;
	 * 
	 * private ExceptionThrower() throws Throwable { if (System
	 * .getProperty("wbp.ReflectionUtils.propagate().InstantiationException") !=
	 * null) { throw new InstantiationException(); } if (System
	 * .getProperty("wbp.ReflectionUtils.propagate().IllegalAccessException") !=
	 * null) { throw new IllegalAccessException(); } throw throwable; }
	 * 
	 * public static synchronized void spit(Throwable t) { if
	 * (System.getProperty("wbp.ReflectionUtils.propagate().dontThrow") == null)
	 * { ExceptionThrower.throwable = t; try {
	 * ExceptionThrower.class.newInstance(); } catch (InstantiationException e)
	 ...
	 *         convenience, to use this method in "throw" statement.
	 */
	/*
	 * public static RuntimeException propagate(Throwable throwable) { if
	 * (System.getProperty("wbp.ReflectionUtils.propagate().forceReturn") ==
	 * null) { ExceptionThrower.spit(throwable); } return null; }
	 */

	/**
	 * @return the {@link Exception} that is given {@link Throwable} or wraps
	 *         it.
	 */
	...
	public static BeanInfo getBeanInfo(Class<?> clazz)
		...
		String[] standard_beanInfoSearchPath = Introspector
	 ...
	 * non-public methods. See (Case 37683).
	 */
	/*
	 * private static boolean isValidForJavaIBM(Method method) { if (method ==
	 * null) { return true; } return !EnvironmentUtils.isJavaIBM() ||
	 * isPublic(method); }
	 */
