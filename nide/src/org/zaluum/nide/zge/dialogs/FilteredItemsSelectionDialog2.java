 ...
 * @since 3.3
 * 
 *        Modified to show initial selection and usable with scala
 */
@SuppressWarnings({ "restriction", "rawtypes", "unchecked" })
public abstract class FilteredItemsSelectionDialog2 extends
	 ...
	 */
	public FilteredItemsSelectionDialog2(Shell shell, boolean multi) {
		super(shell);
		this.multi = multi;
	 ...
	 *            shell to parent the dialog on
	 */
	public FilteredItemsSelectionDialog2(Shell shell) {
		this(shell, false);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		// ZALUUM
		list.setSelection(new StructuredSelection(getInitialElementSelections()));
		// ZALUUM
		return dialogArea;
	}
	...
	private void refreshDetails() {
		...
		case 1:
			...
			break;
		default:
			details.setInput(NLS
					.bind(WorkbenchMessages.FilteredItemsSelectionDialog_nItemsSelected,
	 ...
	 * @see FilteredItemsSelectionDialog2#FULL_SELECTION
	 */
	 ...
	 *            initial pattern for the filter
	 * @param selectionMode
	 *            one of: {@link FilteredItemsSelectionDialog2#NONE},
	 *            {@link FilteredItemsSelectionDialog2#CARET_BEGINNING},
	 *            {@link FilteredItemsSelectionDialog2#FULL_SELECTION}
	 */
	 ...
	 *            {@link FilteredItemsSelectionDialog2.AbstractContentProvider#add(Object, FilteredItemsSelectionDialog2.ItemsFilter)}
	...
	protected void fillContentProvider(AbstractContentProvider contentProvider,
			...
			throws CoreException {
		Iterator i = valuesToFill().iterator();
		while (i.hasNext()) {
			Object o = i.next();
	...
	protected abstract Iterable valuesToFill();
	...
	private class RefreshJob extends UIJob {
		 ...
		 */
		public RefreshJob() {
			super(FilteredItemsSelectionDialog2.this.getParentShell()
					.getDisplay(),
		...
		public IStatus runInUIThread(IProgressMonitor monitor) {
			...
			if (FilteredItemsSelectionDialog2.this != null) {
				FilteredItemsSelectionDialog2.this.refresh();
			}
	...
	private class RefreshProgressMessageJob extends UIJob {
		...
		public RefreshProgressMessageJob() {
			super(
					FilteredItemsSelectionDialog2.this.getParentShell()
							.getDisplay(),
	 ...
	 * 
	 * @see FilteredItemsSelectionDialog2.RefreshJob
	 * 
	 */
		...
		protected IStatus run(IProgressMonitor monitor) {
			...
			if (FilteredItemsSelectionDialog2.this != null) {
				GranualProgressMonitor wrappedMonitor = new GranualProgressMonitor(
						monitor);
				FilteredItemsSelectionDialog2.this.reloadCache(true,
						wrappedMonitor);
			}
	...
	private class GranualProgressMonitor extends ProgressMonitorWrapper {
		...
		private String getMessage() {
			...
			return NLS
					.bind(WorkbenchMessages.FilteredItemsSelectionDialog_taskProgressMessage,
							new Object[] {
									message,
									new Integer(
	 ...
	 * {@link FilteredItemsSelectionDialog2.ItemsFilter#isSubFilter(FilteredItemsSelectionDialog2.ItemsFilter)}
	...
	public abstract class AbstractContentProvider {
		 ...
		 *            the filter
		 * 
		 * @see FilteredItemsSelectionDialog2.ItemsFilter#matchItem(Object)
		 */
	...
	private class ContentProvider extends AbstractContentProvider implements
		...
		public void updateElement(int index) {
			...
			FilteredItemsSelectionDialog2.this.list.replace((lastFilteredItems
		 ...
		 * {@link FilteredItemsSelectionDialog2.ContentProvider#getFilteredItems(Object, IProgressMonitor)}
		 * .
		 * 
		 * @param checkDuplicates
		 *            <code>true</code> if data concerning elements duplication
